...
const global = {
    ...
    api: {
        apiKey: '92ea58866020e972173806ce383fdc7a',
...
function displayPagination() { 
    ...
    // disable previous button if being located in the first page
    if (global.search.page === 1) {
        document.querySelector('#prev').disabled = true;
    }

    // disable next button if being located in the last page
